...
class VehicleStatusVC: UIViewController , UITextFieldDelegate {
    ...
    func convertStatusFormater(_ date: String) -> String {
        let dateFormatter = DateFormatter()
    ...
    func GetVehicleStatusListApi(UserID: String,type: String, startDate: String, endDate: String, statusType: String) {
...
extension VehicleStatusVC: UITableViewDelegate, UITableViewDataSource {
    ...
    @objc func btnViewDetailAction(sender: UIButton) {
        DispatchQueue.main.async {
            ...
            if let vc = UIStoryboard(name: "Vehicle", bundle: nil).instantiateViewController(withIdentifier: "ViewStatusViewDetail") as? ViewStatusViewDetail {
                vc.objApproval = obj
...
extension VehicleStatusVC: UIPickerViewDelegate, UIPickerViewDataSource {
