//
//  VisitorRejectedLogDetailVC.swift
//  EmployeeApp
//
...
class VisitorRejectedLogDetailVC: UIViewController {
...
extension VisitorRejectedLogDetailVC : UIPickerViewDelegate, UIPickerViewDataSource {
...
extension VisitorRejectedLogDetailVC : UITableViewDelegate, UITableViewDataSource{
...
//                cell?.viewMainVehicleNo.isHidden  = false
                ...
                cell?.txtFieldVehicleNumber.text = ""
...
//                cell?.viewMainVehicleNo.isHidden  = true
            ...
            if let url = visitor_Image {
                ...
                cell?.imgVisitors.sd_setImage(with: URL(string:url), placeholderImage: UIImage(named: "nopreview"),
...
//                cell?.viewMainRemark.isHidden  = true
            ...
            if let url = vehicleDetail?.exit.outpass as? String {
            ...
            */
            ...
            if self.vehicleDetail?.approvedBy != "" {
...
extension VisitorRejectedLogDetailVC : UINavigationControllerDelegate, UIImagePickerControllerDelegate {
...
//MARK:-
extension VisitorRejectedLogDetailVC: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
extension VisitorRejectedLogDetailVC : UITextFieldDelegate {
