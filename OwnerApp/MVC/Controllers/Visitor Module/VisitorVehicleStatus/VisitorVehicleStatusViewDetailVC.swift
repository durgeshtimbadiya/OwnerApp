//
//  VisitorVehicleStatusViewDetailVC.swift
//  EmployeeApp
//
...
class VisitorVehicleStatusViewDetailVC: UIViewController {
...
extension VisitorVehicleStatusViewDetailVC : UIPickerViewDelegate, UIPickerViewDataSource {
...
extension VisitorVehicleStatusViewDetailVC : UITableViewDelegate, UITableViewDataSource{
...
//                cell?.viewMainRemark.isHidden  = true
            ...
            if let materialRemark = vehicleDetail?.exit.materialRejectRemark as? String {
            ...
            if let MaterialStatus = self.vehicleDetail?.exit.materialStatus {
                ...
                if MaterialStatus == "1" {
                    ...
                    cell?.viewOutwardChallan.isHidden = true
                    cell?.viewMaterialRemark.isHidden = true
                    // outward challan image , material remark . out pass image and extra space below of it
            ...
            var approvalName = self.dataObj.value(forKey: "approval_given_by") as? String ?? ""
            if self.vehicleDetail?.approvedBy != "" && self.vehicleDetail?.approvedBy != "0" && approvalName != "" && approvalName != "0" {
                cell?.viewEntryApprovalByName.isHidden = false
                cell?.lblEntryApprovalName.text = approvalName
...
extension VisitorVehicleStatusViewDetailVC : UINavigationControllerDelegate, UIImagePickerControllerDelegate {
...
//MARK:-
extension VisitorVehicleStatusViewDetailVC: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
extension VisitorVehicleStatusViewDetailVC : UITextFieldDelegate {
