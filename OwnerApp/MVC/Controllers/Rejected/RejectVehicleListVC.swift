...
class RejectVehicleListVC: UIViewController , UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        if appDelegate.userLoginAccessDetails?.id != nil {
            GetRejectVehicleListApi(UserID: appDelegate.userLoginAccessDetails?.id ?? "", type: "0", startDate: start_Date, endDate: end_Date, statusType: statuss)
        }
    }
...
//            return
    ...
    func GetRejectVehicleListApi(UserID: String,type: String, startDate: String, endDate: String, statusType: String) {
...
extension RejectVehicleListVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if tableView == tblRejectedList {
            ...
            let obj = entry_Array[indexPath.row]
                ...
                cell.lblStatus.text = "Vehicle Rejected"
    ...
    @objc func btnViewDetailAction(sender: UIButton) {
        DispatchQueue.main.async {
            ...
            if let vc = UIStoryboard(name: "Vehicle", bundle: nil).instantiateViewController(withIdentifier: "RejectedVehicleDetailVC") as? RejectedVehicleDetailVC {
                vc.objApproval = obj
...
extension RejectVehicleListVC: UIPickerViewDelegate, UIPickerViewDataSource {
